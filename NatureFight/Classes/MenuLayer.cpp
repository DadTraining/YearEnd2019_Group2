...
void MenuLayer::createButtonLayer()
{
	...
	auto visibleSize = Director::getInstance()->getVisibleSize();
		...
		btnResume->setPosition(mPauseLayer->getPosition() + Vec2(350, 150));
...
void MenuLayer::createSkillIce()
{
	...
	icon_ice->setPosition(Vec2(visibleSize.width-40, visibleSize.height-290));
...
void MenuLayer::createSkillFire() {
	...
	icon_fire->setPosition(Vec2(visibleSize.width - 110, visibleSize.height - 330));
...
void MenuLayer::createFlood()
{
	...
	loadingbgheath->setPosition(inftable->getPosition()+Vec2(30,15));
	...
	loadingbgdame->setPosition(inftable->getPosition() - Vec2(-30, 10));
